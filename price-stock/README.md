price-stock is a service syncing your MySQL data into Elasticsearch automatically.

It uses `mysqldump` to fetch the origin data at first, then syncs data incrementally with binlog.


## release v0.0.16
add full keywords and product river
add t_pro_sell offline realtime river
check map["status"] if exists.
