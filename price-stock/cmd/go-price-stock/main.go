...
import (
	...
	"techtoolkit.ickey.cn/price-stock/river"

	"github.com/juju/errors"
)

var configFile = flag.String("config", "./etc/river.toml", "price-stock config file")
...
var data_dir = flag.String("data_dir", "", "path for price-stock to save data")
