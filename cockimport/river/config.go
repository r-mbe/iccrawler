...
type Config struct {
	...
	CockAddr     string `toml:"cock_addr"`
	CockDBName   string `toml:"cock_dbname"`
	CockUser     string `toml:"cock_user"`
	CockPassword string `toml:"cock_pass"`
	SeelogFile   string `toml:"seelog"`
